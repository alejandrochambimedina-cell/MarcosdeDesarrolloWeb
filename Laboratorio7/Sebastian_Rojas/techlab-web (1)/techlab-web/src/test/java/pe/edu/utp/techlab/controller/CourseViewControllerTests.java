...
class WebRoutesTests {
    ...
    // Pruebas del reto de transferencia: /{id}/duracion
    @Test
    void duracionDevuelveIdYHoras() throws Exception {
    ...
    @Test
    void duracionConIdInexistenteEs404() throws Exception {
        mvc.perform(get("/api/v1/cursos/999/duracion"))
                .andExpect(status().isNotFound());
    }

    @Test
    void duracionConIdNoNumericoEs400() throws Exception {
