...
public class CourseController {
    ...
    // Reto de transferencia: reutiliza buscarPorId y no duplica datos.
    // No entra en conflicto con "/{id}" porque Spring MVC distingue las rutas
    // por el segmento literal adicional "/duracion"; una es una ruta con un
    // único @PathVariable y la otra tiene un segmento fijo extra, por lo que
    // el mapeo es inequívoco.
